...
export const CHANNELS = {
  ...
  settingsSetFishAudioMaxWords: 'settings:setFishAudioMaxWords',
  ...
  mcpSetupWindowsMcp: 'mcp:setupWindowsMcp',
  mcpSetupScreenhand: 'mcp:setupScreenhand',
  ...
  gitUndoLastCommit: 'git:undo-last-commit',
  ...
  gitIsRebasing: 'git:is-rebasing',
  gitCommandLog: 'git:command-log',
  gitRepositoryAction: 'git:repository-action',
