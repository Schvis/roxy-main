...
!(function (t, e) {
  ...
  const g = class {
    ...
    static quadraticEquation(t, e, i) {
      return this.abs(t) < g.Epsilon
        ? this.abs(e) < g.Epsilon
          ? -i
          : -i / e
        : -(e + this.sqrt(e * e - 4 * t * i)) / (2 * t)
    }
    static cardanoAlgorithmForBezier(t, e, i, s) {
      if (this.sqrt(t) < g.Epsilon) return this.range(this.quadraticEquation(e, i, s), 0, 1)
      const r = e / t,
        o = i / t,
        a = (3 * o - r * r) / 3,
        n = a / 3,
        l = (2 * r * r * r - 9 * r * o + 27 * (s / t)) / 27,
        h = l / 2,
        u = h * h + n * n * n,
        d = 0.5,
        c = 0.51
      if (u < 0) {
        ...
        if (this.abs(g - d) < c) return this.range(g, 0, 1)
      ...
      const m = this.sqrt(u),
        p = this.cbrt(m - h) - this.cbrt(m + h) - r / 3
  ...
  let x,
    C = !1,
    M = !1
  const v = { vertexOffset: 0, vertexStep: 2 }
  class P {
    static startUp(t) {
      if (C) return (T('CubismFramework.startUp() is already done.'), C)
      ...
      return (T('CubismFramework.startUp() is complete.'), C)
    }
    static cleanUp() {
      ;((C = !1), (M = !1), (x = void 0))
    }
      ...
      C
        ? M
          ...
          : (Live2DCubismCore.Memory.initializeAmountOfMemory(t),
            (M = !0),
            T('CubismFramework.initialize() is complete.'))
        : I('CubismFramework is not started.')
    }
    static dispose() {
      C
        ? M
          ? (_.staticRelease(), (M = !1), T('CubismFramework.dispose() is complete.'))
    ...
    static getLoggingLevel() {
      return null != x ? x.loggingLevel : b.LogLevel_Off
    }
    constructor() {}
  }
  var b = ((t) => (
  ...
  const S = () => {}
  function w(t, ...e) {
    L.print(b.LogLevel_Debug, '[CSM][D]' + t + '\n', e)
  }
  function T(t, ...e) {
    L.print(b.LogLevel_Info, '[CSM][I]' + t + '\n', e)
  }
  function I(t, ...e) {
    L.print(b.LogLevel_Warning, '[CSM][W]' + t + '\n', e)
  }
  function E(t, ...e) {
    L.print(b.LogLevel_Error, '[CSM][E]' + t + '\n', e)
  }
  class L {
    static print(t, e, i) {
      if (t < P.getLoggingLevel()) return
      const s = P.coreLogFunction
      if (!s) return
    ...
    setPartColor(t, e, i, s, r, o, a) {
      if (
        ...
        for (let n = 0; n < this._partChildDrawables[t].length; ++n) {
          ...
          ;((a[o].Color.R = e), (a[o].Color.G = i), (a[o].Color.B = s), (a[o].Color.A = r))
        }
    }
  ...
  class R {
    ...
    createModel() {
      ...
      if (e) return ((t = new B(e)), ++this._modelCount, t)
    ...
    updateParameters(t, e, i) {
      ...
      ;((s =
        ...
        (0 == this._fadeInSeconds
          ? 1
          : m.getEasingSine((i - e.getFadeInStartTime()) / this._fadeInSeconds)) *
        (0 == this._fadeOutSeconds || e.getEndTime() < 0
          ? 1
          : m.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds))),
        e.setState(i, s),
  ...
  class V extends U {
    ...
    doUpdateParameters(t, e, i, s) {
      for (let r = 0; r < this._parameters.length; ++r) {
        ...
        switch (e.blendType) {
          case G.ExpressionBlendType_Add:
            t.addParameterValueById(e.parameterId, e.value, i)
            break
          case G.ExpressionBlendType_Multiply:
            t.multiplyParameterValueById(e.parameterId, e.value, i)
            break
          case G.ExpressionBlendType_Overwrite:
    ...
    parse(t) {
      ...
      for (let i = 0; i < e; ++i) {
        ...
        o =
          e.Blend && 'Add' !== e.Blend
            ? 'Multiply' === e.Blend
              ? G.ExpressionBlendType_Multiply
              : 'Overwrite' === e.Blend
                ? G.ExpressionBlendType_Overwrite
                : G.ExpressionBlendType_Add
            : G.ExpressionBlendType_Add
  ...
  ;((t.CubismConfig = void 0),
    ((N = t.CubismConfig || (t.CubismConfig = {})).supportMoreMaskDivisions = !0),
    (N.setOpacityFromMotion = !1))
  var X = ((t) => (
  ...
  class $ {
    ...
    getEvaluationOptionFlag(t) {
      return (
        J.EvaluationOptionFlag_AreBeziersRistricted == t && !!this._json.Meta.AreBeziersRestricted
      )
    }
    getMotionCurveCount() {
  ...
  function et(t, e) {
    const i = e,
      ...
      h = 3 * o - 3 * s,
      u = s - i,
      d = m.cardanoAlgorithmForBezier(n, l, h, u),
      c = Q(t[0], t[1], d),
      g = Q(t[1], t[2], d),
      p = Q(t[2], t[3], d),
      _ = Q(c, g, d),
    ...
    for (let l = s.baseSegmentIndex; l < o; ++l)
      if (
        ((a =
          ...
          (t.segments[l].segmentType == z.CubismMotionSegmentType_Bezier ? 3 : 1)),
        t.points[a].time > i)
      ) {
        r = l
        break
  ...
  class ot extends U {
    ...
    doUpdateParameters(e, i, s, r) {
      ;(null == this._modelCurveIdEyeBlink && (this._modelCurveIdEyeBlink = 'EyeBlink'),
        ...
        null == this._modelCurveIdOpacity && (this._modelCurveIdOpacity = Z))
      ...
      ;(this._eyeBlinkParameterIds.length > l &&
        w('too many eye blink targets : {0}', this._eyeBlinkParameterIds.length),
        this._lipSyncParameterIds.length > l &&
          w('too many lip sync targets : {0}', this._lipSyncParameterIds.length))
      const d =
          this._fadeInSeconds <= 0
            ? 1
            : m.getEasingSine((i - r.getFadeInStartTime()) / this._fadeInSeconds),
        c =
          this._fadeOutSeconds <= 0 || r.getEndTime() < 0
            ? 1
            : m.getEasingSine((r.getEndTime() - i) / this._fadeOutSeconds)
      let g,
        p,
        _,
        f = o
      if (this._isLoop) for (; f > this._motionData.duration; ) f -= this._motionData.duration
      const y = this._motionData.curves
      for (
        p = 0;
        p < this._motionData.curveCount && y[p].type == X.CubismMotionCurveTarget_Model;
        ++p
      )
        ((g = rt(this._motionData, p, f)),
          y[p].id == this._modelCurveIdEyeBlink
            ? (n = g)
            : y[p].id == this._modelCurveIdLipSync
              ? (a = g)
              : y[p].id == this._modelCurveIdOpacity &&
                ((this._modelOpacity = g), e.setModelOapcity(this.getModelOpacityValue())))
      for (
        ;
        p < this._motionData.curveCount && y[p].type == X.CubismMotionCurveTarget_Parameter;
        ++p
      ) {
        if (((_ = e.getParameterIndex(y[p].id)), -1 == _)) continue
        const t = e.getParameterValueByIndex(_)
        if (((g = rt(this._motionData, p, f)), n != Number.MAX_VALUE))
        ...
        let o
        if (y[p].fadeInTime < 0 && y[p].fadeOutTime < 0) o = t + (g - t) * s
        else {
          let e, s
          ;((e =
            y[p].fadeInTime < 0
              ...
              : 0 == y[p].fadeInTime
                ? 1
                : m.getEasingSine((i - r.getFadeInStartTime()) / y[p].fadeInTime)),
            (s =
              y[p].fadeOutTime < 0
                ? c
                : 0 == y[p].fadeOutTime || r.getEndTime() < 0
                  ? 1
                  : m.getEasingSine((r.getEndTime() - i) / y[p].fadeOutTime)))
          o = t + (g - t) * (this._weight * e * s)
        }
        e.setParameterValueByIndex(_, o, 1)
      }
      ...
      for (
        ;
        p < this._motionData.curveCount && y[p].type == X.CubismMotionCurveTarget_PartOpacity;
        ++p
      )
        if (((g = rt(this._motionData, p, f)), t.CubismConfig.setOpacityFromMotion))
          e.setPartOpacityById(y[p].id, g)
        else {
          if (((_ = e.getParameterIndex(y[p].id)), -1 == _)) continue
          e.setParameterValueByIndex(_, g)
        }
      ;(o >= this._motionData.duration &&
        (this._isLoop
          ? (r.setStartTime(i), this._isLoopFadeIn && r.setFadeInStartTime(i))
          : (this._onFinishedMotion && this._onFinishedMotion(this), r.setIsFinished(!0))),
        (this._lastWeight = s))
    }
    setIsLoop(t) {
      this._isLoop = t
    ...
    parse(t) {
      ...
      const i = e.getEvaluationOptionFlag(J.EvaluationOptionFlag_AreBeziersRistricted),
      ...
      for (let n = 0; n < this._motionData.curveCount; ++n) {
        ...
        switch (e.getMotionCurveTarget(n)) {
          case 'Model':
            t.type = X.CubismMotionCurveTarget_Model
            break
          case 'Parameter':
            t.type = X.CubismMotionCurveTarget_Parameter
            break
          case 'PartOpacity':
            t.type = X.CubismMotionCurveTarget_PartOpacity
            break
          default:
            I(
        ...
        for (let l = 0; l < e.getMotionCurveSegmentCount(n); ) {
          0 == l
            ? ((this._motionData.segments[a].basePointIndex = o),
              (this._motionData.points[o] = new j(
          ...
          switch (e.getMotionCurveSegment(n, l)) {
            case z.CubismMotionSegmentType_Linear:
              ;((this._motionData.segments[a].segmentType = z.CubismMotionSegmentType_Linear),
                (this._motionData.segments[a].evaluate = K),
                (this._motionData.points[o] = new j(
                  e.getMotionCurveSegment(n, l + 1),
            ...
            case z.CubismMotionSegmentType_Bezier:
              ;((this._motionData.segments[a].segmentType = z.CubismMotionSegmentType_Bezier),
                (this._motionData.segments[a].evaluate = i ? tt : et),
                (this._motionData.points[o] = new j(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
                (this._motionData.points[o + 1] = new j(
                  e.getMotionCurveSegment(n, l + 3),
                  e.getMotionCurveSegment(n, l + 4)
                )),
                (this._motionData.points[o + 2] = new j(
            ...
            case z.CubismMotionSegmentType_Stepped:
              ;((this._motionData.segments[a].segmentType = z.CubismMotionSegmentType_Stepped),
                (this._motionData.segments[a].evaluate = it),
                (this._motionData.points[o] = new j(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
            ...
            case z.CubismMotionSegmentType_InverseStepped:
              ;((this._motionData.segments[a].segmentType =
                z.CubismMotionSegmentType_InverseStepped),
                (this._motionData.segments[a].evaluate = st),
                (this._motionData.points[o] = new j(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
    ...
    isExistModelOpacity() {
      for (let t = 0; t < this._motionData.curveCount; t++) {
        ...
        if (e.type == X.CubismMotionCurveTarget_Model && e.id === Z) return !0
      }
      return !1
    }
    getModelOpacityIndex() {
      if (this.isExistModelOpacity())
        for (let t = 0; t < this._motionData.curveCount; t++) {
          const e = this._motionData.curves[t]
          if (e.type == X.CubismMotionCurveTarget_Model && e.id === Z) return t
        }
      return -1
    }
    getModelOpacityId(t) {
      if (-1 != t) {
        const e = this._motionData.curves[t]
        if (e.type == X.CubismMotionCurveTarget_Model && e.id === Z) return e.id
      }
    }
    getModelOpacityValue() {
      return this._modelOpacity
  ...
  class nt {
    ...
    doUpdateMotion(t, e) {
      ...
      for (; s < this._motions.length; ) {
        ...
        for (let t = 0; t < a.length; ++t) this._eventCallBack(this, a[t], this._eventCustomData)
  ...
  class yt {
      ...
      for (let o = 0; o < this._physicsRig.subRigCount; ++o) {
        ...
        for (let i = 0; i < t.inputCount; ++i) {
          ...
          switch (
            ...
            case 'X':
              ;((t.type = ut.CubismPhysicsSource_X), (t.getNormalizedParameterValue = Mt))
              break
            case 'Y':
              ;((t.type = ut.CubismPhysicsSource_Y), (t.getNormalizedParameterValue = vt))
              break
            case ft:
              ;((t.type = ut.CubismPhysicsSource_Angle), (t.getNormalizedParameterValue = Pt))
          }
          ;((t.source.targetType = ht.CubismPhysicsTargetType_Parameter),
        ...
        for (let i = 0; i < t.outputCount; ++i) {
          ...
          switch (
            (t || ((t = new mt()), (this._physicsRig.outputs[s + i] = t)),
            ...
            (t.destination.targetType = ht.CubismPhysicsTargetType_Parameter),
            (t.destination.id = e.getOutputDestinationId(o, i)),
            e.getOutputType(o, i))
          ) {
            case 'X':
              ;((t.type = ut.CubismPhysicsSource_X), (t.getValue = bt), (t.getScale = It))
              break
            case 'Y':
              ;((t.type = ut.CubismPhysicsSource_Y), (t.getValue = St), (t.getScale = Et))
              break
            case ft:
              ;((t.type = ut.CubismPhysicsSource_Angle), (t.getValue = wt), (t.getScale = Lt))
          }
    ...
    stabilization(t) {
      ...
      ;((_ = t.getModel().parameters.values),
        ...
        (null != (r = null == (s = this._parameterInputCaches) ? void 0 : s.length) ? r : 0) <
          t.getParameterCount() &&
          (this._parameterInputCaches = new Float32Array(t.getParameterCount())))
      for (let c = 0; c < t.getParameterCount(); ++c)
        ((this._parameterCaches[c] = _[c]), (this._parameterInputCaches[c] = _[c]))
      for (let C = 0; C < this._physicsRig.subRigCount; ++C) {
        ;((o = { angle: 0 }),
          ...
          (g = this._physicsRig.outputs.slice(u.baseOutputIndex)),
          (p = this._physicsRig.particles.slice(u.baseParticleIndex)))
        for (let e = 0; e < u.inputCount; ++e)
          ((a = d[e].weight / 100),
            ...
            (this._parameterCaches[d[e].sourceParameterIndex] = _[d[e].sourceParameterIndex]))
        ;((n = m.degreesToRadian(-o.angle)),
          (h.x = h.x * m.cos(n) - h.y * m.sin(n)),
          (h.y = h.x * m.sin(n) + h.y * m.cos(n)),
          Ft(
            p,
            u.particleCount,
            h,
        ...
        for (let e = 0; e < u.outputCount; ++e) {
          const i = g[e].vertexIndex
          if (
            (-1 == g[e].destinationParameterIndex &&
              (g[e].destinationParameterIndex = t.getParameterIndex(g[e].destination.id)),
            i < 1 || i >= u.particleCount)
          )
            continue
          let s = new c()
          ;((s = p[i].position.substract(p[i - 1].position)),
            (l = g[e].getValue(s, p, i, g[e].reflect, this._options.gravity)),
            (this._currentRigOutputs[C].outputs[e] = l),
            (this._previousRigOutputs[C].outputs[e] = l))
          const r = g[e].destinationParameterIndex,
            o =
              !Float32Array.prototype.slice && 'subarray' in Float32Array.prototype
                ? JSON.parse(JSON.stringify(_.subarray(r)))
                : _.slice(r)
          Dt(o, y[r], f[r], l, g[e])
          for (let t = r, e = 0; t < this._parameterCaches.length; t++, e++)
            _[t] = this._parameterCaches[t] = o[e]
        }
      }
    }
    evaluate(t, e) {
      ...
      if (
        ...
        (null != (s = null == (i = this._parameterCaches) ? void 0 : i.length) ? s : 0) <
          t.getParameterCount() &&
          (this._parameterCaches = new Float32Array(t.getParameterCount())),
        (null != (o = null == (r = this._parameterInputCaches) ? void 0 : r.length) ? o : 0) <
          t.getParameterCount())
      ) {
        this._parameterInputCaches = new Float32Array(t.getParameterCount())
        for (let e = 0; e < t.getParameterCount(); ++e) this._parameterInputCaches[e] = f[e]
      }
      for (
        ...
        for (let t = 0; t < this._physicsRig.subRigCount; ++t) {
          ;((d = this._physicsRig.settings[t]),
            (p = this._physicsRig.outputs.slice(d.baseOutputIndex)))
          for (let e = 0; e < d.outputCount; ++e)
            this._previousRigOutputs[t].outputs[e] = this._currentRigOutputs[t].outputs[e]
        }
        ...
        for (let i = 0; i < this._physicsRig.subRigCount; ++i) {
          ;((a = { angle: 0 }),
            ...
            (g = this._physicsRig.inputs.slice(d.baseInputIndex)),
            (p = this._physicsRig.outputs.slice(d.baseOutputIndex)),
            (_ = this._physicsRig.particles.slice(d.baseParticleIndex)))
          for (let e = 0; e < d.inputCount; ++e)
            ((n = g[e].weight / 100),
              ...
              g[e].getNormalizedParameterValue(
                ...
                x[g[e].sourceParameterIndex],
                y[g[e].sourceParameterIndex],
          ...
          ;((l = m.degreesToRadian(-a.angle)),
            (u.x = u.x * m.cos(l) - u.y * m.sin(l)),
            (u.y = u.x * m.sin(l) + u.y * m.cos(l)),
            At(
              _,
              d.particleCount,
              u,
          ...
          for (let e = 0; e < d.outputCount; ++e) {
            const s = p[e].vertexIndex
            if (
              (-1 == p[e].destinationParameterIndex &&
                (p[e].destinationParameterIndex = t.getParameterIndex(p[e].destination.id)),
            ...
            ;((r.x = _[s].position.x - _[s - 1].position.x),
              ...
              (h = p[e].getValue(r, _, s, p[e].reflect, this._options.gravity)),
              (this._currentRigOutputs[i].outputs[e] = h))
            const o = p[e].destinationParameterIndex,
              a =
                !Float32Array.prototype.slice && 'subarray' in Float32Array.prototype
      ...
      for (let s = 0; s < this._physicsRig.subRigCount; ++s) {
        ...
        for (let s = 1; s < e.particleCount; ++s)
          ((i = new c(0, 0)),
            ...
            (t[s].position = new c(t[s].initialPosition.x, t[s].initialPosition.y)),
            (t[s].lastPosition = new c(t[s].initialPosition.x, t[s].initialPosition.y)),
  ...
  function Mt(t, e, i, s, r, o, a, n, l, h) {
    t.x += Bt(i, s, r, o, a.minimum, a.maximum, a.defalut, l) * h
  }
  function vt(t, e, i, s, r, o, a, n, l, h) {
    t.y += Bt(i, s, r, o, a.minimum, a.maximum, a.defalut, l) * h
  }
  function Pt(t, e, i, s, r, o, a, n, l, h) {
    e.angle += Bt(i, s, r, o, n.minimum, n.maximum, n.defalut, l) * h
  }
  function bt(t, e, i, s, r) {
    let o = t.x
    return (s && (o *= -1), o)
  }
  function St(t, e, i, s, r) {
    let o = t.y
    return (s && (o *= -1), o)
  }
  ...
  function At(t, e, i, s, r, o, a, n) {
    ...
    ;((t[0].position = new c(i.x, i.y)),
      (l = m.degreesToRadian(s)),
      (d = m.radianToDirection(l)),
      d.normalize())
    for (let y = 1; y < e; ++y)
      ((t[y].force = d.multiplyByScaler(t[y].acceleration).add(r)),
        ...
        (u = m.directionToRadian(t[y].lastGravity, d) / n),
        (g.x = m.cos(u) * g.x - g.y * m.sin(u)),
        (g.y = m.sin(u) * g.x + g.y * m.cos(u)),
        (t[y].position = t[y - 1].position.add(g)),
        ...
        m.abs(t[y].position.x) < o && (t[y].position.x = 0),
        0 != h &&
  ...
  function Ft(t, e, i, s, r, o) {
    let a,
      n,
      l = new c(0, 0)
    ;((t[0].position = new c(i.x, i.y)),
      (a = m.degreesToRadian(s)),
      (n = m.radianToDirection(a)),
      n.normalize())
    for (let h = 1; h < e; ++h)
      ((t[h].force = n.multiplyByScaler(t[h].acceleration).add(r)),
        (t[h].lastPosition = new c(t[h].position.x, t[h].position.y)),
        (t[h].velocity = new c(0, 0)),
        (l = t[h].force),
        l.normalize(),
        (l = l.multiplyByScaler(t[h].radius)),
        (t[h].position = t[h - 1].position.add(l)),
        m.abs(t[h].position.x) < o && (t[h].position.x = 0),
        (t[h].force = new c(0, 0)),
        (t[h].lastGravity = new c(n.x, n.y)))
  }
  ...
  class Vt {
    ...
    getMaskRenderTexture() {
      if (this._maskTexture && null != this._maskTexture.textures)
        ...
        ;(this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Ut),
          (this._maskTexture = new Nt(this._currentFrameNo, this._maskRenderTextures)))
      }
    ...
    calcClippedDrawTotalBounds(t, e) {
      ...
      for (let n = 0; n < a; n++) {
        ...
        let u = Number.MAX_VALUE,
          ...
          c = -Number.MAX_VALUE,
          g = -Number.MAX_VALUE
        const m = l * v.vertexStep
        for (let t = v.vertexOffset; t < m; t += v.vertexStep) {
          const e = h[t],
            i = h[t + 1]
    ...
    initialize(t, e, i, s, r) {
      ...
      for (let o = 0; o < e; o++) {
        ...
        ;(null == t && ((t = new Gt(this, i[o], s[o])), this._clippingContextListForMask.push(t)),
    ...
    setupClippingContext(t, e) {
      ...
      if (i > 0) {
        ...
        for (let t = 0; t < this._renderTextureCount; t++) this._clearedFrameBufferflags[t] = !1
        for (let i = 0; i < this._clippingContextListForMask.length; i++) {
        ...
        e.isUsingHighPrecisionMask() ||
          ...
          this.gl.viewport(kt[0], kt[1], kt[2], kt[3]))
      }
    }
    findSameClip(t, e) {
      for (let i = 0; i < this._clippingContextListForMask.length; i++) {
  ...
  class zt {
    static getInstance() {
      return null == Ot ? ((Ot = new zt()), Ot) : Ot
    }
    static deleteInstance() {
      Ot && (Ot.release(), (Ot = void 0))
    }
    constructor() {
      this._shaderSets = []
    }
    ...
    setupShaderProgram(t, e, i, s, r, o, a, n, l, h, u, d, c, g, m) {
      let p, _, y, x
      ;(c || E('NoPremultipliedAlpha is not allowed'),
        0 == this._shaderSets.length && this.generateShaders())
      const C = t.getClippingContextBufferForMask()
      if (null != C) {
        const t = this._shaderSets[jt.ShaderNames_SetupMask]
        ...
        ;(this.gl.uniform4f(t.uniformChannelFlagLocation, r.R, r.G, r.B, r.A),
          this.gl.uniformMatrix4fv(t.uniformClipMatrixLocation, !1, C._matrixForMask.getArray()))
        const n = C._layoutBounds
        ;(this.gl.uniform4f(
        ...
        switch (l) {
          ...
          default:
            ;((n = this._shaderSets[jt.ShaderNames_NormalPremultipliedAlpha + r]),
              (p = this.gl.ONE),
          ...
          case f.CubismBlendMode_Additive:
            ;((n = this._shaderSets[jt.ShaderNames_AddPremultipliedAlpha + r]),
              (p = this.gl.ONE),
              (_ = this.gl.ONE),
              (y = this.gl.ZERO),
              (x = this.gl.ONE))
          ...
          case f.CubismBlendMode_Multiplicative:
            ;((n = this._shaderSets[jt.ShaderNames_MultPremultipliedAlpha + r]),
              (p = this.gl.DST_COLOR),
              (_ = this.gl.ONE_MINUS_SRC_ALPHA),
              (y = this.gl.ZERO),
              (x = this.gl.ONE))
      ...
      ;(null == a.index && (a.index = this.gl.createBuffer()),
        ...
        this.gl.blendFuncSeparate(p, _, y, x))
    }
    ...
    generateShaders() {
      ...
      ;((this._shaderSets[0].shaderProgram = this.loadShaderProgram(Wt, Ht)),
        (this._shaderSets[1].shaderProgram = this.loadShaderProgram(Yt, $t)),
        (this._shaderSets[2].shaderProgram = this.loadShaderProgram(qt, Jt)),
        (this._shaderSets[3].shaderProgram = this.loadShaderProgram(qt, Zt)),
    ...
    loadShaderProgram(t, e) {
      ...
      if (!s) return (E('Vertex shader compile error!'), 0)
      const r = this.compileShaderSource(this.gl.FRAGMENT_SHADER, e)
      if (!r) return (E('Vertex shader compile error!'), 0)
    ...
    compileShaderSource(t, e) {
      ...
      if ((this.gl.shaderSource(s, i), this.gl.compileShader(s), !s)) {
        E('Shader compile log: {0} ', this.gl.getShaderInfoLog(s))
      }
  ...
  class Qt extends _ {
    ...
    initialize(t, e = 1) {
      ...
      for (let i = t.getDrawableCount() - 1; i >= 0; i--) this._sortedDrawableIndexList[i] = 0
      super.initialize(t)
    }
    bindTexture(t, e) {
      this._textures[t] = e
    ...
    drawMesh(t, e, i, s, r, o, a, n, l, h, u) {
      ...
      null == this.getClippingContextBufferForMask() &&
        ((d.A *= l), this.isPremultipliedAlpha() && ((d.R *= d.A), (d.G *= d.A), (d.B *= d.A)))
      let c = null
  ...
  var le
  ;((t.config = void 0),
    ((le = t.config || (t.config = {})).LOG_LEVEL_VERBOSE = 0),
    (le.LOG_LEVEL_WARNING = 1),
    (le.LOG_LEVEL_ERROR = 2),
    (le.LOG_LEVEL_NONE = 999),
    (le.logLevel = le.LOG_LEVEL_WARNING),
    (le.sound = !0),
    (le.motionSync = !0),
    (le.motionFadingDuration = 500),
    (le.idleMotionFadingDuration = 2e3),
    (le.expressionFadingDuration = 500),
    (le.preserveExpressionOnMotion = !0),
    (le.cubism4 = t.CubismConfig))
  const he = {
    log(e, ...i) {
  ...
  class me extends e.EventEmitter {
    ...
    loadExpression(t) {
      return __async(this, null, function* () {
        if (!this.definitions[t]) return void he.warn(this.tag, `Undefined expression at [${t}]`)
  ...
  class pe {
    ...
    focus(t, e, i = !1) {
      ;((this.targetX = ue(t, -1, 1)),
        (this.targetY = ue(e, -1, 1)),
    ...
    update(t) {
      ...
      let o = r * (e / s) - this.vx,
        a = r * (i / s) - this.vy
      const n = Math.sqrt(__pow(o, 2) + __pow(a, 2)),
        l = 0.006666666666666667 * r * t
      ;(n > l && ((o *= l / n), (a *= l / n)), (this.vx += o), (this.vy += a))
  ...
  class _e {
    constructor(t) {
      ...
      ;((this.url = e), (this.name = ce(this.url)))
    }
    resolveURL(t) {
  ...
  class ye {
    ...
    reserve(t, e, i) {
      if (i <= 0) return (he.log(this.tag, 'Cannot start a motion with MotionPriority.NONE.'), !1)
      if (t === this.currentGroup && e === this.currentIndex)
        return (he.log(this.tag, 'Motion is already playing.', this.dump(t, e)), !1)
      if (
        (t === this.reservedGroup && e === this.reservedIndex) ||
        (t === this.reservedIdleGroup && e === this.reservedIdleIndex)
      )
        return (he.log(this.tag, 'Motion is already reserved.', this.dump(t, e)), !1)
      if (1 === i) {
  ...
  class xe {
    ...
    static add(t, e, i) {
      ...
      return (
        ...
        s.addEventListener('error', (e) => {
          ;(this.dispose(s),
            he.warn('SoundManager', `Error occurred on "${t}"`, e.error),
            null == i || i(e.error))
        }),
        this.audios.push(s),
        s
    ...
    static analyze(t) {
      if (null != t) {
        let e = new Float32Array(t.fftSize),
          i = 0
    ...
    static dispose(t) {
      ;(t.pause(), t.removeAttribute('src'), ge(this.audios, t))
    }
    static destroy() {
  ...
  ;((xe.audios = []), (xe.analysers = []), (xe.contexts = []), (xe._volume = 0.9))
  ...
  class Me extends e.EventEmitter {
    ...
    loadMotion(t, e) {
      return __async(this, null, function* () {
        ...
        if (!(null == (i = this.definitions[t]) ? void 0 : i[e]))
          return void he.warn(this.tag, `Undefined motion at "${t}"[${e}]`)
    ...
    speakUp(e) {
      return __async(
        this,
        arguments,
        function* (e, { volume: i = 1, expression: s, resetExpression: r = !0 } = {}) {
          if (!t.config.sound) return !1
          let o, a, n, l
          if (this.currentAudio && !this.currentAudio.ended) return !1
          const h = e && e.startsWith('data:audio/wav;base64')
          if (e && !h) {
            var u = document.createElement('a')
            ;((u.href = e), (l = e = u.href))
          } else l = 'data:audio/wav;base64'
          let d
          ;((e && (e.startsWith('http') || e.startsWith('blob'))) || h) && (d = e)
          const c = this
          if (d)
            try {
              ;((o = xe.add(
                d,
                () => {
                  ;(r && s && c.expressionManager && c.expressionManager.resetExpression(),
                    (c.currentAudio = void 0))
                },
                () => {
                  ;(r && s && c.expressionManager && c.expressionManager.resetExpression(),
                    (c.currentAudio = void 0))
              ...
              ;(void 0 !== i && (t = i),
                (xe.volume = t),
                (n = xe.addContext(this.currentAudio)),
                (this.currentContext = n),
                (a = xe.addAnalyzer(this.currentAudio, this.currentContext)),
                (this.currentAnalyzer = a))
            } catch (g) {
              he.warn(this.tag, 'Failed to create audio', l, g)
            }
          if (o) {
            const e = xe.play(o).catch((t) => he.warn(this.tag, 'Failed to play audio', o.src, t))
    ...
    startMotion(e, i) {
      return __async(
        ...
        function* (
          ...
          i,
          s = fe.NORMAL,
          { sound: r, volume: o = 1, expression: a, resetExpression: n = !0 } = {}
        ) {
          var l
          if (this.currentAudio && !this.currentAudio.ended) return !1
          if (!this.state.reserve(e, i, s)) return !1
          const h = null == (l = this.definitions[e]) ? void 0 : l[i]
          if (!h) return !1
          let u, d, c
          if ((this.currentAudio && xe.dispose(this.currentAudio), t.config.sound)) {
            const t = r && r.startsWith('data:audio/wav;base64')
            if (r && !t) {
              var g = document.createElement('a')
              ;((g.href = r), (r = g.href))
            }
            const e = r && (r.startsWith('http') || r.startsWith('blob')),
              i = this.getSoundFile(h)
            let s = i
            ;(i && (s = this.settings.resolveURL(i) + '?cache-buster=' + new Date().getTime()),
              (e || t) && (s = r))
            const l = this
            if (s)
              try {
                ;((u = xe.add(
                  s,
                  () => {
                    ;(n && a && l.expressionManager && l.expressionManager.resetExpression(),
                      (l.currentAudio = void 0))
                  },
                  () => {
                    ;(n && a && l.expressionManager && l.expressionManager.resetExpression(),
                      (l.currentAudio = void 0))
                ...
                ;(void 0 !== o && (t = o),
                  (xe.volume = t),
                  (c = xe.addContext(this.currentAudio)),
                  (this.currentContext = c),
                  (d = xe.addAnalyzer(this.currentAudio, this.currentContext)),
                  (this.currentAnalyzer = d))
              } catch (p) {
                he.warn(this.tag, 'Failed to create audio', i, p)
              }
          }
          const m = yield this.loadMotion(e, i)
          if (u) {
            s = 3
            const e = xe.play(u).catch((t) => he.warn(this.tag, 'Failed to play audio', u.src, t))
            t.config.motionSync && (yield e)
          }
          return this.state.start(m, e, i, s)
            ? (this.state.shouldOverrideExpression() &&
                this.expressionManager &&
                this.expressionManager.resetExpression(),
              he.log(this.tag, 'Start motion:', this.getMotionName(h)),
              this.emit('motionStart', e, i, u),
              a && this.expressionManager && this.expressionManager.setExpression(a),
              (this.playing = !0),
              this._startMotion(m),
              !0)
            : (u && (xe.dispose(u), (this.currentAudio = void 0)), !1)
        }
      )
    }
    startRandomMotion(t, e) {
      return __async(
        this,
        arguments,
        function* (t, e, { sound: i, volume: s = 1, expression: r, resetExpression: o = !0 } = {}) {
          const a = this.definitions[t]
          if (null == a ? void 0 : a.length) {
            const n = []
            for (let e = 0; e < a.length; e++)
              null === this.motionGroups[t][e] || this.state.isActive(t, e) || n.push(e)
            if (n.length) {
    ...
    stopSpeaking() {
      this.currentAudio && (xe.dispose(this.currentAudio), (this.currentAudio = void 0))
    }
    stopAllMotions() {
      ...
      return (
        this.isFinished() &&
          ...
          this.state.shouldRequestIdleMotion() &&
            this.startRandomMotion(this.groups.idle, fe.IDLE)),
        this.updateParameters(t, e)
      )
    }
    mouthSync() {
      return this.currentAnalyzer ? xe.analyze(this.currentAnalyzer) : 0
    }
    destroy() {
      var t
      ;((this.destroyed = !0),
  ...
  const ve = { x: 0, y: 0, width: 0, height: 0 }
  class Pe extends e.EventEmitter {
    constructor() {
      ;(super(...arguments),
        (this.focusController = new pe()),
    ...
    getDrawableBounds(t, e) {
      ...
      for (let n = 0; n < i.length; n += 2) {
        const t = i[n],
          e = i[n + 1]
        ;((s = Math.min(t, s)), (r = Math.max(t, r)), (o = Math.min(e, o)), (a = Math.max(e, a)))
      }
      return (null != e || (e = {}), (e.x = s), (e.y = o), (e.width = r - s), (e.height = a - o), e)
    }
    updateTransform(t) {
  ...
  const Se = class {
    static createXHR(t, e, i, s, r) {
      ...
      if ((Se.allXhrSet.add(o), t)) {
        let e = Se.xhrMap.get(t)
        ;(e ? e.add(o) : ((e = new Set([o])), Se.xhrMap.set(t, e)),
          t.listeners('destroy').includes(Se.cancelXHRs) || t.once('destroy', Se.cancelXHRs))
      }
      return (
        o.open('GET', e),
        (o.responseType = i),
        (o.onload = () => {
          ;(200 !== o.status && 0 !== o.status) || !o.response ? o.onerror() : s(o.response)
        }),
        (o.onerror = () => {
          ;(he.warn(
            'XHRLoader',
            ...
            r(new be('Network error.', e, o.status)))
        }),
        (o.onabort = () => r(new be('Aborted.', e, o.status, !0))),
        (o.onloadend = () => {
          var e
          ;(Se.allXhrSet.delete(o), t && (null == (e = Se.xhrMap.get(t)) || e.delete(o)))
        }),
        o
      )
    }
    static cancelXHRs() {
      var t
      ;(null == (t = Se.xhrMap.get(this)) ||
        t.forEach((t) => {
          ;(t.abort(), Se.allXhrSet.delete(t))
        }),
        Se.xhrMap.delete(this))
    }
    static release() {
      ;(Se.allXhrSet.forEach((t) => t.abort()), Se.allXhrSet.clear(), (Se.xhrMap = new WeakMap()))
    }
  }
  let we = Se
  function Te(t, e) {
  ...
  ;((we.xhrMap = new WeakMap()),
    (we.allXhrSet = new Set()),
    (we.loader = (t, e) =>
      new Promise((e, i) => {
        Se.createXHR(
          t.target,
  ...
  class Ie {
    static load(t) {
      return Te(this.middlewares, t).then(() => t.result)
    }
  }
  Ie.middlewares = [we.loader]
  const Ee = 'Live2DFactory',
    Le = (t, e) =>
      __async(this, null, function* () {
        if ('string' == typeof t.source) {
          const e = yield Ie.load({ url: t.source, type: 'json', target: t.live2dModel })
    ...
    Ae = (t, e) =>
      __async(this, null, function* () {
        if (t.source instanceof _e) return ((t.settings = t.source), e())
        if ('object' == typeof t.source) {
          const i = ke.findRuntime(t.source)
          if (i) {
    ...
    Fe = (t, e) => {
      if (t.settings) {
        const i = ke.findRuntime(t.settings)
      ...
      __async(this, null, function* () {
        ...
        if (i) {
          ...
          if (s) {
            ...
            ;(e.pose &&
              r.push(
                Ie.load({ settings: e, url: e.pose, type: 'json', target: i })
                  .then((e) => {
                  ...
                  .catch((e) => {
                    ;(t.live2dModel.emit('poseLoadError', e),
                      he.warn(Ee, 'Failed to load pose.', e))
                  })
              ),
              e.physics &&
                r.push(
                  Ie.load({ settings: e, url: e.physics, type: 'json', target: i })
                    .then((e) => {
                    ...
                    .catch((e) => {
                      ;(t.live2dModel.emit('physicsLoadError', e),
                        he.warn(Ee, 'Failed to load physics.', e))
                    })
                ),
    ...
    Oe = class {
      static registerRuntime(t) {
        ;(Oe.runtimes.push(t), Oe.runtimes.sort((t, e) => e.version - t.version))
      }
      static findRuntime(t) {
        for (const e of Oe.runtimes) if (e.test(t)) return e
      }
      static setupLive2DModel(t, e, i) {
        return __async(this, null, function* () {
          const s = new Promise((e) => t.once('textureLoaded', e)),
            r = new Promise((e) => t.once('modelLoaded', e)),
            o = Promise.all([s, r]).then(() => t.emit('ready'))
          ;(yield Te(Oe.live2DModelMiddlewares, { live2dModel: t, source: e, options: i || {} }),
            yield o,
            t.emit('load'))
        })
      }
      static loadMotion(t, e, i) {
        ...
        try {
          const o = null == (s = t.definitions[e]) ? void 0 : s[i]
          if (!o) return Promise.resolve(void 0)
          t.listeners('destroy').includes(Oe.releaseTasks) || t.once('destroy', Oe.releaseTasks)
          let a = Oe.motionTasksMap.get(t)
          a || ((a = {}), Oe.motionTasksMap.set(t, a))
          let n = a[e]
          n || ((n = []), (a[e] = n))
          const l = t.getMotionFile(o)
          return (
            null != n[i] ||
              (n[i] = Ie.load({ url: l, settings: t.settings, type: t.motionDataType, target: t })
                .then((s) => {
                  var r
                  const a = null == (r = Oe.motionTasksMap.get(t)) ? void 0 : r[e]
                  a && delete a[i]
                  const n = t.createMotion(s, e, o)
                  return (t.emit('motionLoaded', e, i, n), n)
                })
                .catch((e) => {
                  ;(he.warn(t.tag, `Failed to load motion: ${l}\n`, e), r(e))
                })),
            n[i]
          )
        } catch (o) {
          ;(he.warn(t.tag, `Failed to load motion at "${e}"[${i}]\n`, o), r(o))
        }
      ...
      static loadExpression(t, e) {
        ...
        try {
          ...
          t.listeners('destroy').includes(Oe.releaseTasks) || t.once('destroy', Oe.releaseTasks)
          let r = Oe.expressionTasksMap.get(t)
          r || ((r = []), Oe.expressionTasksMap.set(t, r))
          const o = t.getExpressionFile(s)
          return (
            null != r[e] ||
              (r[e] = Ie.load({ url: o, settings: t.settings, type: 'json', target: t })
                .then((i) => {
                  const r = Oe.expressionTasksMap.get(t)
                  r && delete r[e]
                  const o = t.createExpression(i, s)
                  return (t.emit('expressionLoaded', e, o), o)
                })
                .catch((e) => {
                  ;(he.warn(t.tag, `Failed to load expression: ${o}\n`, e), i(e))
                })),
            r[e]
          )
        } catch (s) {
          ;(he.warn(t.tag, `Failed to load expression at [${e}]\n`, s), i(s))
        }
        return Promise.resolve(void 0)
      }
      static releaseTasks() {
        this instanceof Me ? Oe.motionTasksMap.delete(this) : Oe.expressionTasksMap.delete(this)
      }
    }
  let ke = Oe
  ;((ke.runtimes = []),
    (ke.urlToJSON = Le),
    (ke.jsonToSettings = Ae),
    (ke.waitUntilReady = Fe),
    (ke.setupOptionals = De),
    (ke.setupEssentials = Be),
    (ke.createInternalModel = Re),
    (ke.live2DModelMiddlewares = [Le, Ae, Fe, De, Be, Re]),
    (ke.motionTasksMap = new WeakMap()),
    (ke.expressionTasksMap = new WeakMap()),
    (Me.prototype._loadMotion = function (t, e) {
      return ke.loadMotion(this, t, e)
    }),
    (me.prototype._loadExpression = function (t) {
      return ke.loadExpression(this, t)
    }))
  class Ue {
    constructor() {
    ...
    set autoInteract(t) {
      t !== this._autoInteract &&
        (t ? this.on('pointertap', Ve, this) : this.off('pointertap', Ve, this),
        (this._autoInteract = t))
    }
    registerInteraction(t) {
      t !== this.interactionManager &&
        (this.unregisterInteraction(),
        this._autoInteract && t && ((this.interactionManager = t), t.on('pointermove', Ne, this)))
    }
    unregisterInteraction() {
      var t
      this.interactionManager &&
        (null == (t = this.interactionManager) || t.off('pointermove', Ne, this),
  ...
  class Ge extends i.Transform {}
  const Xe = new i.Point(),
    ze = new i.Matrix()
  let je
  class We extends r.Container {
    constructor(t) {
      ;(super(),
        (this.tag = 'Live2DModel(uninitialized)'),
        (this.textures = []),
        (this.transform = new Ge()),
    ...
    static from(t, e) {
      const i = new this(e)
      return ke.setupLive2DModel(i, t, e).then(() => i)
    }
    static fromSync(t, e) {
      const i = new this(e)
      return (
    ...
    set autoUpdate(t) {
      var e
      ;(je || (je = null == (e = window.PIXI) ? void 0 : e.Ticker),
        t
          ? this._destroyed ||
            (je
              ? (je.shared.add(this.onTickerUpdate, this), (this._autoUpdate = !0))
              : he.warn(
                  this.tag,
                  'No Ticker registered, please call Live2DModel.registerTicker(Ticker).'
                ))
          : (null == je || je.shared.remove(this.onTickerUpdate, this), (this._autoUpdate = !1)))
    }
    init(t) {
    ...
    motion(
      t,
      e,
      { priority: i = 2, sound: s, volume: r = 1, expression: o, resetExpression: a = !0 } = {}
    ) {
      return void 0 === e
    ...
    speak(t, { volume: e = 1, expression: i, resetExpression: s = !0 } = {}) {
      return this.internalModel.motionManager.speakUp(t, {
        volume: e,
        expression: i,
        resetExpression: s
      })
    ...
    focus(t, e, i = !1) {
      ;((Xe.x = t), (Xe.y = e), this.toModelPosition(Xe, Xe, !0))
      let s = (Xe.x / this.internalModel.originalWidth) * 2 - 1,
        r = (Xe.y / this.internalModel.originalHeight) * 2 - 1,
        o = Math.atan2(r, s)
      this.internalModel.focusController.focus(Math.cos(o), -Math.sin(o), i)
    }
    tap(t, e) {
      const i = this.hitTest(t, e)
      i.length && (he.log(this.tag, 'Hit', i), this.emit('hit', i))
    }
    hitTest(t, e) {
      return (
        (Xe.x = t),
        (Xe.y = e),
        this.toModelPosition(Xe, Xe),
        this.internalModel.hitTest(Xe.x, Xe.y)
      )
    }
    ...
    _render(t) {
      ...
      ;((this.internalModel.viewport = [i.x, i.y, i.width, i.height]),
        this.deltaTime &&
          (this.internalModel.update(this.deltaTime, this.elapsedTime), (this.deltaTime = 0)))
      const s = ze.copyFrom(t.globalUniforms.uniforms.projectionMatrix).append(this.worldTransform)
  ...
  const He = class {
    static resolveURL(t, e) {
      var i
      const s = null == (i = He.filesMap[t]) ? void 0 : i[e]
    ...
    static upload(t, i) {
      return __async(this, null, function* () {
        ...
        for (const r of i.getDefinedFiles()) {
          const o = decodeURI(e.url.resolve(i.url, r)),
            a = t.find((t) => t.webkitRelativePath === o)
          a && (s[r] = URL.createObjectURL(a))
        }
        He.filesMap[i._objectURL] = s
      })
    }
    static createSettings(t) {
      return __async(this, null, function* () {
        ...
        const i = yield He.readText(e),
          s = JSON.parse(i)
        s.url = e.webkitRelativePath
        const r = ke.findRuntime(s)
    ...
    (Ye.factory = (t, e) =>
      __async(this, null, function* () {
        if (Array.isArray(t.source) && t.source[0] instanceof File) {
          ...
          } else i = yield He.createSettings(e)
          ;(i.validateFiles(e.map((t) => encodeURI(t.webkitRelativePath))),
            yield He.upload(e, i),
            (i.resolveURL = function (t) {
              return He.resolveURL(this._objectURL, t)
            }),
            (t.source = i),
            t.live2dModel.once('modelLoaded', (t) => {
              t.once('destroy', function () {
                const t = this.settings._objectURL
                if ((URL.revokeObjectURL(t), He.filesMap[t]))
                  for (const e of Object.values(He.filesMap[t])) URL.revokeObjectURL(e)
                delete He.filesMap[t]
              })
            }))
        }
        return e()
      })),
    ke.live2DModelMiddlewares.unshift(Ye.factory))
  const qe = class {
    static unzip(t, i) {
      return __async(this, null, function* () {
        const s = yield qe.getFilePaths(t),
          r = []
        for (const t of i.getDefinedFiles()) {
          const o = decodeURI(e.url.resolve(i.url, t))
          s.includes(o) && r.push(o)
        }
        const o = yield qe.getFiles(t, r)
  ...
  if (
    ...
    ($e.factory = (t, e) =>
      __async(this, null, function* () {
        ...
        let s, r, o
        if (
          ('string' == typeof i && (i.endsWith('.zip') || i.startsWith(qe.ZIP_PROTOCOL))
            ? ((s = i.startsWith(qe.ZIP_PROTOCOL) ? i.slice(qe.ZIP_PROTOCOL.length) : i),
              (r = yield Ie.load({ url: s, type: 'blob', target: t.live2dModel })))
            : Array.isArray(i) &&
              1 === i.length &&
              i[0] instanceof File &&
          ...
          const e = yield qe.zipReader(r, s)
          ;(o || (o = yield qe.createSettings(e)),
            (o._objectURL = qe.ZIP_PROTOCOL + qe.uid + '/' + o.url))
          const i = yield qe.unzip(e, o)
          ;((i.settings = o),
            (t.source = i),
            s.startsWith('blob:') &&
              t.live2dModel.once('modelLoaded', (t) => {
    ...
    ke.live2DModelMiddlewares.unshift($e.factory),
  ...
  class Ze extends _e {
    constructor(t) {
      if ((super(t), !Ze.isValidJSON(t))) throw new TypeError('Invalid JSON.')
  ...
  class Qe extends Me {
    ...
    init(t) {
      ;(super.init(t),
        this.settings.expressions && (this.expressionManager = new Je(this.settings, t)),
    ...
    createMotion(e, i, s) {
      ...
      return (
        void 0 === o.getMotionFadeInTime() && r.setFadeInTime(s.FadeInTime > 0 ? s.FadeInTime : a),
        void 0 === o.getMotionFadeOutTime() &&
          r.setFadeOutTime(s.FadeOutTime > 0 ? s.FadeOutTime : a),
  ...
  class ti extends Pe {
    constructor(t, e, s) {
      ;(super(),
        (this.lipSync = !0),
        (this.breath = o.create()),
        (this.renderer = new Qt()),
        (this.idParamAngleX = te),
        (this.idParamAngleY = ee),
        (this.idParamAngleZ = ie),
        (this.idParamEyeBallX = se),
        (this.idParamEyeBallY = re),
        (this.idParamBodyAngleX = ae),
        (this.idParamBreath = ne),
        (this.idParamMouthForm = oe),
        (this.pixelsPerUnit = 1),
        (this.centeringTransform = new i.Matrix()),
        (this.coreModel = t),
        (this.settings = e),
        (this.motionManager = new Qe(e, s)),
        this.init())
    }
    init() {
      var t
      ;(super.init(),
        (null == (t = this.settings.getEyeBlinkParameters()) ? void 0 : t.length) > 0 &&
          (this.eyeBlink = l.create(this.settings)),
        this.breath.setParameters([
          new a(this.idParamAngleX, 0, 15, 6.5345, 0.5),
          new a(this.idParamAngleY, 0, 8, 3.5345, 0.5),
          new a(this.idParamAngleZ, 0, 10, 5.5345, 0.5),
          new a(this.idParamBodyAngleX, 0, 4, 15.5345, 0.5),
          new a(this.idParamBreath, 0, 0.5, 3.2345, 0.5)
        ]),
          ...
          (ei = new Promise((t, e) => {
            !(function i() {
              try {
                ...
                ;(he.log('Cubism4', 'Startup failed, retrying 10ms later...'), setTimeout(i, 10))
              }
            })()
          })),
        ei)
  ...
  function ri(t) {
    ;((t = Object.assign({ logFunction: console.log, loggingLevel: b.LogLevel_Verbose }, t)),
      P.startUp(t),
      P.initialize())
  }
  function oi() {
  ...
  ;(ke.registerRuntime({
    version: 4,
    ready: si,
    test: (t) => t instanceof Ze || Ze.isValidJSON(t),
    isValidMoc(t) {
      if (t.byteLength < 4) return !1
      const e = new Int8Array(t, 0, 4)
      return 'MOC3' === String.fromCharCode(...e)
    },
    createModelSettings: (t) => new Ze(t),
    createCoreModel(t, e) {
      const i = R.create(t, !!(null == e ? void 0 : e.checkMocConsistency))
      try {
    ...
    createInternalModel(t, e, i) {
      const s = new ti(t, e, i),
        r = t
      return (r.__moc && ((s.__moc = r.__moc), delete r.__moc, s.once('destroy', oi)), s)
    },
    createPhysics: (t, e) => yt.create(e),
    createPose: (t, e) => u.create(e)
  }),
    (t.ACubismMotion = U),
    (t.BreathParameterData = a),
    (t.CSM_ASSERT = S),
    (t.Constant = v),
    (t.Cubism4ExpressionManager = Je),
    (t.Cubism4InternalModel = ti),
    (t.Cubism4ModelSettings = Ze),
    (t.Cubism4MotionManager = Qe),
    (t.CubismBlendMode = f),
    (t.CubismBreath = o),
    (t.CubismClippingContext = Gt),
    (t.CubismClippingManager_WebGL = Vt),
    (t.CubismDebug = L),
    (t.CubismExpressionMotion = V),
    (t.CubismEyeBlink = l),
    (t.CubismFramework = P),
    (t.CubismLogDebug = w),
    (t.CubismLogError = E),
    ...
    (t.CubismLogVerbose = function (t, ...e) {
      L.print(b.LogLevel_Verbose, '[CSM][V]' + t + '\n', e)
    }),
    (t.CubismLogWarning = I),
    (t.CubismMath = m),
    (t.CubismMatrix44 = p),
    (t.CubismMoc = R),
    (t.CubismModel = B),
    (t.CubismModelSettingsJson = Kt),
    (t.CubismModelUserData = k),
    (t.CubismModelUserDataJson = O),
    (t.CubismMotion = ot),
    (t.CubismMotionCurve = H),
    (t.CubismMotionCurveTarget = X),
    (t.CubismMotionData = q),
    (t.CubismMotionEvent = Y),
    (t.CubismMotionJson = $),
    (t.CubismMotionManager = class extends nt {
      constructor() {
    ...
    (t.CubismMotionQueueEntry = at),
    (t.CubismMotionQueueManager = nt),
    (t.CubismMotionSegment = W),
    (t.CubismMotionSegmentType = z),
    (t.CubismPhysics = yt),
    (t.CubismPhysicsInput = gt),
    (t.CubismPhysicsJson = _t),
    (t.CubismPhysicsOutput = mt),
    (t.CubismPhysicsParticle = dt),
    (t.CubismPhysicsRig = pt),
    (t.CubismPhysicsSource = ut),
    (t.CubismPhysicsSubRig = ct),
    (t.CubismPhysicsTargetType = ht),
    (t.CubismPose = u),
    (t.CubismRenderTextureResource = Nt),
    (t.CubismRenderer = _),
    (t.CubismRendererProfile_WebGL = Xt),
    (t.CubismRenderer_WebGL = Qt),
    (t.CubismShader_WebGL = zt),
    (t.CubismTextureColor = y),
    (t.CubismVector2 = c),
    (t.DrawableColorData = A),
    (t.DrawableCullingData = D),
    (t.EvaluationOptionFlag = J),
    (t.ExpressionBlendType = G),
    (t.ExpressionManager = me),
    (t.EyeState = h),
    (t.FileLoader = Ye),
    (t.FocusController = pe),
    (t.HitAreaBody = 'Body'),
    (t.HitAreaHead = 'Head'),
    (t.HitAreaPrefix = 'HitArea'),
    (t.InteractionMixin = Ue),
    (t.InternalModel = Pe),
    (t.InvalidMotionQueueEntryHandleValue = lt),
    (t.LOGICAL_HEIGHT = 2),
    (t.LOGICAL_WIDTH = 2),
    (t.Live2DFactory = ke),
    (t.Live2DLoader = Ie),
    (t.Live2DModel = We),
    (t.Live2DTransform = Ge),
    (t.LogLevel = b),
    (t.ModelSettings = _e),
    (t.MotionManager = Me),
    ...
    (t.fragmentShaderSrcMaskPremultipliedAlpha = Jt),
    (t.fragmentShaderSrcPremultipliedAlpha = $t),
    (t.fragmentShaderSrcsetupMask = Ht),
    (t.logger = he),
    (t.rand = function (t, e) {
    ...
    (t.remove = ge),
    (t.startUpCubism4 = ri),
    (t.vertexShaderSrc = Yt),
    (t.vertexShaderSrcMasked = qt),
    (t.vertexShaderSrcSetupMask = Wt),
